export default function EdexcelIGCSEResources() {
  return (
    <div className="max-w-4xl mx-auto mb-24">
      <h1 className="text-4xl font-bold text-blue-600 mb-8 text-center">Edexcel IGCSE Resources</h1>
      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="font-bold mb-3">January 2023</h3>
              <ul className="space-y-2">
                <li>• Paper 1F/1H</li>
                <li>• Paper 2F/2H</li>
                <li>• Mark Schemes</li>
